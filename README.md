...
[Product site](https://hmumixam.github.io/monica-next/) · [中文](README.zh.md) · [Deployment](docs/DEPLOYMENT.md) · [Contributing](CONTRIBUTING.md) · [Security](SECURITY.md)
...
> Screenshots of the actual frontend using independently written synthetic fixtures. Contact labels, relationships, messages, organizations, and counts are fictional. No real names, portraits, accounts, locations, private conversations, or deployment addresses are included.
...
A longer walkthrough lives on the [GitHub Pages site](https://hmumixam.github.io/monica-next/).
...
Read [CONTRIBUTING.md](CONTRIBUTING.md) for development and isolated test setup. CI checks Python tests and lint, TypeScript, the Next.js build, Compose configuration, and container builds.
